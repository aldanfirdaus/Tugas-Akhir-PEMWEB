<?php
  ...
  $data = mysqli_query($koneksi,'select * from akun where status_vote = 0 order by npm ASC');
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="row no-gutters mt-5">
  ...
  <div class="col-sm-10 p-5 pt-5">
    ...
    <h3 style="margin-left: 20px"><i class="fas fa-user-slash"></i> Mahasiswa belum memilih</h3><hr>
